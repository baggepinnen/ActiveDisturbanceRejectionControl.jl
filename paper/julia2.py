...
__all__ = ['Julia2Lexer', 'Julia2ConsoleLexer']

allowed_variable = \
    '(?:[a-zA-Z_\u00A1-\U0010ffff]|%s)(?:[a-zA-Z_0-9\u00A1-\U0010ffff])*!*'

class Julia2Lexer(RegexLexer):
    """
    ...
    base_modules = r'\b(?:BLAS|Base|Broadcast|DFT|Docs|Iterators|LAPACK|LibGit2|Libc|Libdl|LinAlg|Markdown|Meta|Operators|Pkg|Serializer|SparseArrays|StackTraces|Sys|Threads|Core|Main|ControlSystems|CUDA|MonteCarloMeasurements|Optim|SymPy|Polynomials|OrdinaryDiffEq|DelayDiffEq|Symbolics)\b'
